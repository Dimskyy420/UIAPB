    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Pantau semua aktivitas tugasmu',
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return _buildEmpty(
            ...
            subtitle: 'Periksa koneksi internetmu',
        ...
        return ListView.builder(
          ...
          itemBuilder: (_, i) {
            ...
            return _RequestCard(
                request: r, controller: widget.controller);
          },
        );
      },
    );
...
class _RequestCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusLabel =
        RiwayatController.requestStatusLabel[request.status] ??
            request.status;
                ...
                Row(
                  children: [
                    _MetaChip(
                        ...
                        label: request.date.isEmpty ? '-' : request.date,
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<RequestModel?>(
      ...
      builder: (context, snap) {
        ...
        final colorIndex =
            (title.isNotEmpty ? title.codeUnitAt(0) : 0) %
                _avatarColors.length;
        final avatarColor = _avatarColors[colorIndex];
